// Исходная функция:
            ...
            string Func1(string input, string elementName, string attrName)
            {
                    ...
                    if (startElEndex != -1)
                    {
                        if (line[startElEndex - 1] == '<')
                        {
                            ...
                            if (attrStartIndex != -1)
                            {
                                ...
                                {
                                    result += line[valueStartIndex]; // StringBuilder.
                                    valueStartIndex++;
                                }
...
// Доработанная функция 
			...
			string Func2(string input, string elementName, string attrName)
            {
